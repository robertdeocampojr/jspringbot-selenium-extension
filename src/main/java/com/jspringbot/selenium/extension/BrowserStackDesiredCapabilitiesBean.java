...
public class BrowserStackDesiredCapabilitiesBean implements InitializingBean, DisposableBean {
    ...
    public BrowserStackDesiredCapabilitiesBean(DesiredCapabilities capabilities) {
